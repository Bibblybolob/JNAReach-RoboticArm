...
>
> This documented the workspace when it still had an adaptive gripper, was
> mounted upside-down, and was aimed at food handling. All three have changed:
> the gripper is gone, the arm is mounted base-down facing up, and the target
> task is pressing elevator buttons.
>
> Sections below that describe the gripper planning group, gripper open/close
> services, or the food-detection workflow no longer match the code. The
> collision-obstacle and teach-mode sections are still broadly accurate.
>
> See the top-level [README.md](../README.md) for current setup instructions.
